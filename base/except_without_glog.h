...
[[noreturn]] inline void except(
  ...
  if constexpr (has_exception_support()) {
    ndyn::hal::output::print("[");
    ndyn::hal::output::print(location.function_name());
    ndyn::hal::output::print(" (");
    ndyn::hal::output::print(location.file_name());
    ndyn::hal::output::print(":");
    ndyn::hal::output::print(location.line());
    ndyn::hal::output::print(")] -- ");
    ndyn::hal::output::println(msg);
...
[[noreturn]] inline void except(
  ...
  if constexpr (has_exception_support()) {
    ...
    ndyn::hal::output::print(location.line());
    ndyn::hal::output::print(")] -- ");
    ndyn::hal::output::print(msg);
    ndyn::hal::output::print(" (");
    ndyn::hal::output::print(ec.message().c_str());
    ndyn::hal::output::println(")");
