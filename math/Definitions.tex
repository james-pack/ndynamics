...
This section discusses how various operators operate on multivectors.

\begin{enumerate}
  \item \textbf{Addition}
        Addition of multivectors follows the concepts behind the addition of vectors. Multivector addition is performed by summing the corresponding components of two vectors that share the same coordinate basis. Each basis blade is considered to be an independent coordinate basis for this operation.
...
\begin{enumerate}
  ...
  \item \textbf{Pseudoscalar}
        The pseudoscalar is the result of multiplying all of the basis vectors together. If the quadratic form is positive definite (all positive and no zero entries), the square of the pseudoscalar is $-1$.
